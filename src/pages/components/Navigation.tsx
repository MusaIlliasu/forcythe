...
const Navigation = () => {
  ...
  return (
    <div className="w-full h-[70px] flex justify-center items-center sticky top-0 left-0 py-2 px-[5%] z-40">
        <div className="w-full flex justify-between items-center gap-4">
            ...
            <List size={24} weight="regular" color="#fff" className="inline-block md:hidden cursor-pointer" />
        </div>
    </div>
  )
}
